...
import { TomoContenedor } from './TomoConteiner/TomoContenedor';
...
export const ItemDetail = ({id, nombre, descripcion, precioTomo, img, categoria, cantidadDeTomos,stock}) => {
  ...
  const volverAtras = () =>{
    ...
    return (
        ...
        <div className='itemDetailContainer'>
            ...
            <div class= "seccion3">
            {/* <TomoContenedor cantT={cantidadDeTomos} /> */}
